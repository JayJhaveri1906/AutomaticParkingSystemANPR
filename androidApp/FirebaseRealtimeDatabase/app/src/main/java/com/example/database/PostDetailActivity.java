...
public class PostDetailActivity extends BaseActivity implements View.OnClickListener {
	...
	private DatabaseReference mPostReference, mCommentsReference ,mChatRef;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		// Initialize Database
		mPostReference = FirebaseDatabase.getInstance().getReference().child("user-posts").child(getUid()).child("History").child(mPostKey);
		mCommentsReference = FirebaseDatabase.getInstance().getReference().child("post-comments").child(mPostKey);
		mChatRef = FirebaseDatabase.getInstance().getReference().child("chat").child(mPostKey);
	}
	...
	public void onStart() {
		...
		ValueEventListener postListener = new ValueEventListener() {
			...
			public void onDataChange(DataSnapshot dataSnapshot) {
				...
				mTitleView.setText(post.body);
				mBodyView.setText("Parking Time :"+String.valueOf(post.Parking_time)+"\nCost :"+String.valueOf(post.Cost)+"\n"+post.Status);
			}
